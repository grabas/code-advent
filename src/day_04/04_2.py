...
def get_number_of_winning_numbers(scratchcard):
    winning_numbers, scratched_numbers = split_scratchcard(scratchcard)

    return len(list((winning_numbers.intersection(scratched_numbers))))


def process_card(card, index, total_cards):
    number_of_winning_numbers = get_number_of_winning_numbers(card) + 1
    total_cards += 1
